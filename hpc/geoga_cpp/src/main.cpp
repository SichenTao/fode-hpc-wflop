...
Missing information: original Anholt numerical inputs and author executable
Reconstruction: thin CLI over geoga_declared_reconstruction_v1 and its declared execution contract
